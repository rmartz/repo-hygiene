...
function headingText(raw: string): string {
  // codeql[js/incomplete-multi-character-sanitization] - output used for slug comparison only, never rendered as HTML; slugify strips all non-letter/number chars
